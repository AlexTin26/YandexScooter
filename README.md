...
После выполнения теста вы увидите результаты, включая сообщения об успехе или неудаче каждого шага теста. Также будет отображен статус выполнения заказа и получения данных о заказе.